...
public class DesktopFrame extends JFrame {
    ...
    private final JXStatusBar statusBar = createStatusBar();
    private final JTabbedPane tabbedPane = new JTabbedPane();
    private final CloseAction closeAction = new CloseAction(tabbedPane);
    private final CloseAllAction closeAllAction = new CloseAllAction(tabbedPane);
